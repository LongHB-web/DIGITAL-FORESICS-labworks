...
forme1 = cv.imread(r'C:\Users\MY PC\Downloads\opencv\sources\samples\data\forme1.png',cv.IMREAD_GRAYSCALE)
lena = cv.imread(r'C:\Users\MY PC\Downloads\opencv\sources\samples\data\lena.png',cv.IMREAD_GRAYSCALE)
forme3 = cv.imread(r'C:\Users\MY PC\Downloads\opencv\sources\samples\data\forme3.png',cv.IMREAD_GRAYSCALE)
